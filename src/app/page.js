...
function AuroraBackgroundDemo() {
  return (
    <div
  className="relative w-full h-screen bg-responsive mt-16 bg-gray flex flex-col justify-center items-center"
...
>
      ...
      <div className="w-full lg:w-3/4 flex flex-col lg:flex-row justify-center gap-8 px-4 lg:px-10 mt-16 lg:mt-0">
        <motion.div
          ...
          className="w-full lg:w-1/2 flex justify-center items-center mt-16"
        >
          <video
        ...
        <motion.div
          ...
          className="w-full lg:w-1/2 hidden lg:block mt-16"  // Hide on mobile
        >
          <video
            className="rounded-md border"
